...
import com.example.mykotlin.helper.MqttHelper
import org.eclipse.paho.client.mqttv3.IMqttDeliveryToken
import org.eclipse.paho.client.mqttv3.MqttCallbackExtended
import org.eclipse.paho.client.mqttv3.MqttMessage

class MainFragment : Fragment, View.OnClickListener {
    var disableButton: Button? = null
        private set
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        disableButton = view.findViewById<View>(R.id.disable) as Button
        ...
        dataReceived = view.findViewById<View>(R.id.textview_second) as TextView
    ...
    override fun onClick(view: View) {
        if (view === disableButton) {
            if (!(requireActivity() as MainActivity).overdrive) {
                pomodoroTechnique()
            } else {
